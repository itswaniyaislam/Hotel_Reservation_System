...
public class Hotel {
    ...
    public void makeReservation(Reservation reservation) {
        ...
        if (reservations.contains(reservation)) throw new IllegalStateException("Reservation already exists");
        reservations.add(reservation);
    }

    public void cancelReservation(Reservation reservation) {
        if (!reservations.remove(reservation)) throw new IllegalStateException("Reservation not found");
    }
